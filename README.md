...
|---------|---------|-------------|
| **NFC Tag Reader App** | [![NFC App](assets/nfc_demo_thumb.jpg)](https://youtu.be/YOUR_NFC_VIDEO_LINK) | Secure NFC reader app (ISO7816 + NFCNDEFTag protocols) with SHA-256 decryption in Swift. |
